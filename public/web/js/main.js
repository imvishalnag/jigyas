...
jQuery(document).ready(function () {
    ...
    $window.on("load", function () {
        ...
        new WOW().init();
        $(".grid-masonry").masonry({ itemSelector: ".grid-item", columnWidth: ".grid-item" });
        $("#status").fadeOut();
        $("#preloader").delay(350).fadeOut("slow");
    });
    ...
    $("#navigation").onePageNav({ currentClass: "active", changeHash: true, scrollSpeed: 1000, scrollThreshold: 0.5, filter: "", easing: "swing", begin: function () {}, end: function () {}, scrollChange: function ($currentListItem) {} });
    ...
    mt_personal.Isotope();
    $(".various").fancybox({ maxWidth: 800, maxHeight: 600, fitToView: false, width: "70%", height: "70%", autoSize: false, closeClick: true, openEffect: "elastic", closeEffect: "none" });
    ...
    var FancYB = $(".fancybox");
    FancYB.fancybox({ openEffect: "fade", closeEffect: "fade", padding: 0, closeBtn: true, helpers: { title: { type: "inside" }, overlay: { locked: false }, buttons: {} } });
    ...
    $(".slider-items").slick({ infinite: true, autoplay: true, arrows: true, dots: false, slidesToShow: 1, slidesToScroll: 1, responsive: [{ breakpoint: 767, settings: { slidesToShow: 1, slidesToScroll: 1, infinite: true } }] });
    $(".slider-insta").slick({
        infinite: true,
        autoplay: true,
        arrows: true,
        ...
        slidesToScroll: 2,
        responsive: [
            { breakpoint: 767, settings: { slidesToShow: 5, slidesToScroll: 1, infinite: true } },
            { breakpoint: 480, settings: { slidesToShow: 3, slidesToScroll: 1, infinite: true } },
        ],
    });
    $(".slider-insta1").slick({
        infinite: true,
    ...
    $(".slider-partner").slick({
        ...
        slidesToScroll: 1,
        responsive: [
            { breakpoint: 639, settings: { slidesToShow: 3, slidesToScroll: 1, infinite: true } },
            { breakpoint: 480, settings: { slidesToShow: 2, slidesToScroll: 1, infinite: true } },
        ],
    });
    $(".edu_team_slider").slick({
        ...
        slidesToScroll: 1,
        responsive: [
            { breakpoint: 991, settings: { slidesToShow: 2, slidesToScroll: 1, dots: false } },
            { breakpoint: 570, settings: { slidesToShow: 1, slidesToScroll: 1, dots: false } },
        ],
    });
    $(".chef_team").slick({ infinite: true, autoplay: true, arrows: false, dots: false, slidesToShow: 1, slidesToScroll: 1 });
    $(".edu_team_slider3").slick({
        ...
        responsive: [
            ...
            { breakpoint: 570, settings: { slidesToShow: 1, slidesToScroll: 1, infinite: true } },
            { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1, arrows: false, infinite: true } },
        ],
    });
    $(".slider-ft-course").slick({
        ...
        responsive: [
            { breakpoint: 991, settings: { slidesToShow: 2, slidesToScroll: 1, infinite: true } },
            { breakpoint: 767, settings: { slidesToShow: 2, slidesToScroll: 1, infinite: true, arrows: false } },
            { breakpoint: 639, settings: { slidesToShow: 1, slidesToScroll: 1, infinite: true, arrows: false } },
        ],
    });
    ...
    $(".slider-eductestimo").slick({ infinite: true, autoplay: false, arrows: false, dots: false, slidesToShow: 1, slidesToScroll: 1 });
    $(".slider-eductestimo1").slick({
        ...
        slidesToScroll: 1,
        responsive: [
            { breakpoint: 991, settings: { slidesToShow: 2, slidesToScroll: 1, infinite: true, arrows: false } },
            { breakpoint: 570, settings: { slidesToShow: 1, slidesToScroll: 1, infinite: true } },
        ],
    });
    ...
    jQuery(".skillbar").each(function () {
        jQuery(this)
            .find(".skillbar-bar")
            .animate({ width: jQuery(this).attr("data-percent") }, 6000);
    });
});
$(document).ready(function () {
...
function initMap() {
    ...
    var latlng = new google.maps.LatLng(27.7172, 85.324);
    var map = new google.maps.Map(document.getElementById("map"), { center: latlng, scrollwheel: false, styles: styleArray, zoom: 13 });
}
...
function screenshotSlider() {
    ...
    if (cSlider.length) {
        cSlider.owlCarousel({ loop: true, dots: true, autoplay: true, autoplayTimeout: 4000, smartSpeed: 1200, lazyLoad: true, responsive: { 0: { items: 1 }, 551: { items: 2 }, 768: { items: 3 }, 1200: { items: 5 } } });
    }
}
